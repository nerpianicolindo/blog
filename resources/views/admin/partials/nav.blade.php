<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        <img src="/img/riders.jpeg" alt="Imagen no disponible" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="https://pbs.twimg.com/profile_images/1214943394893647872/jjC5kkQK_400x400.jpg" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
                <a href="#" class="d-block">{{ auth()->user()->name }}</a>
                <p class="d-block text-white">{{ auth()->user()->roles()->first()->name }}</p>
            </div>
        </div>
